...
async def extract_keywords(state: DataQueryAgentState, runtime: Runtime[DataQueryAgentContext]):
    ...
    try:
        ...
        # extract_tags 会基于 TF-IDF（文本逆文档频率） 抽取关键词，并按 allowPOS（允许保留的词性） 做词性过滤
