...
class TableConfig:
    ...
    role: str # 表角色
    description: str # 表说明
    columns: list[ColumnConfig] # 字段列表，每个字段对应一个 ColumnConfig 对象
...
class MetaConfig:
    ...
    tables: Optional[list[TableConfig]] = None # 表列表
    metrics: Optional[list[MetricConfig]] = None # 指标列表
