...
async def get_query_service(
    ...
    # QueryService 只接收已经创建好的依赖对象，本身不关心这些对象来自 MySQL、Milvus 还是 ES
    return QueryService(
        meta_mysql_repository=meta_mysql_repository,# 元数据仓储
        embedding_client=embedding_client, # 嵌入模型客户端
        dw_mysql_repository=dw_mysql_repository, # 数仓仓储
